                                ...
                                return function (body) {
                                    ...
                                    userIdPromise.then(userId => {
                                        if (bodyJSON.settings)
                                            setToStorage(STORAGE_KEYS.SETTINGS(userId), JSON.stringify(bodyJSON.settings));
                                        if (bodyJSON.columns)
                                            setToStorage(STORAGE_KEYS.SETTINGS_COLUMN_IDS(userId), JSON.stringify(bodyJSON.columns));
